...
from notehub.views import home, register, sign_in, signup_view, login_view, logout_view,return_view, add_document_view, add_exam_view, add_exercise_view,  add_note_view
